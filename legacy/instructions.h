...
/*
 *
 * optimized multiplication with 128bit SSE instrutions 
 *
 */
template <class T>
static inline double mul128( SIMDAligned16Array<T>* restrict p, SIMDAligned16Array<T>* restrict q )
{
	if ( p->size() != q->size() )
...
/*
 *
 * optimized multiplication with 256bit SSE/AVX instrutions 
 *
 */
template <class T>
static inline double mul256( SIMDAligned32Array<T>* restrict p, SIMDAligned32Array<T>* restrict q )
{
